        ...
        $(document).on('submit', 'form#contact_form', function (e) {
            ...
            $('.requiredField').each(function () {
                ...
                if ($.trim($(this).val()) == '') {
                    ...
                    $(this).parent().append('<span class="error">Merci de renseigner les champs obligatoires.</span>');
                    ...
                    if (!emailReg.test($.trim($(this).val()))) {
						...
						$(this).parent().append('<span class="error">Cet adresse email est invalide</span>');
            ...
            if (!hasError) {
                ...
                $.post($(this).attr('action'), formInput, function (data) {
                    ...
                    $('form#contact_form').slideUp("fast", function () {
                        ...
                        $(this).before('<p class="success">Merci ! Je vous contacterai très bientôt !</p>');
